...
export default function AboutPage() {
  ...
  return (
<div className="min-h-screen bg-white/5 text-gray-800 text-xs sm:text-base pt-16 sm:pt-20">      {/* Hero Section */}
      <div className="relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 pt-12 pb-8 sm:pt-16 sm:pb-22">
          <div className="text-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-green-700 mb-2 sm:mb-10">
              About <span className="bg-gradient-to-r from-blue-400 to-green-700 bg-clip-text text-transparent">LabXCode</span>
            </h1>
            <p className="text-sm sm:text-lg text-gray-900 max-w-3xl mx-auto leading-relaxed px-2">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-10">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 items-center">
          <div>
            ...
            <div className="text-gray-900 space-y-3 sm:space-y-5 text-xs sm:text-base leading-relaxed">
              <p>
          ...
          <div className="relative mt-6 lg:mt-0">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-4 sm:p-6 border border-white/20">
              <div className="text-center">
                <div className="text-4xl sm:text-5xl font-bold text-blue-700 mb-2 sm:mb-3">2025</div>
                <div className="text-base sm:text-lg text-green-900 font-bold mb-4">Founded on Oct 20</div>
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div>
                    <div className="text-lg sm:text-xl font-bold text-blue-800">100+</div>
                    <div className="text-[10px] sm:text-sm text-gray-600">Projects</div>
                  </div>
                  <div>
                    <div className="text-lg sm:text-xl font-bold text-green-800">50+</div>
                    <div className="text-[10px] sm:text-sm text-gray-600">Happy Clients</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Mission Section */}
      <div className="bg-white/5 backdrop-blur-sm py-8 sm:py-10">
        <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-blue-800 mb-4 sm:mb-6">Our Mission</h2>
          <p className="text-xs sm:text-lg text-gray-900 leading-relaxed">
      ...
      <div className="bg-gradient-to-r from-blue-900 to-green-700/80 py-8 sm:py-10">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-5">Why Choose LabXCode?</h2>
            <p className="text-xs sm:text-lg text-gray-300">What makes us different</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center group">
                <div className="bg-white w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-5 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-[10px] sm:text-sm text-gray-300 leading-relaxed">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-10">
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-blue-800 mb-4 sm:mb-6">Our Commitment</h2>
          <div className="max-w-4xl mx-auto">
            <p className="text-xs sm:text-lg text-gray-900 leading-relaxed mb-4 sm:mb-6">
            ...
            <div className="bg-gradient-to-r from-blue-800/70 to-green-600 rounded-2xl p-5 sm:p-7 text-white">
      ...
      {/* CTA Section */}
      <div className="relative px-3 sm:px-6 lg:px-8 py-8 sm:py-10 text-center">
        ...
        <div className="relative max-w-4xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-bold text-blue-800 mb-3 sm:mb-5">
            Ready to Transform Your Digital Presence?
          </h2>
          <p className="text-xs sm:text-lg text-gray-600 mb-5 sm:mb-7">
            Let's build something amazing together
          </p>
          <button className="bg-white text-green-800 font-bold px-5 sm:px-8 py-2 sm:py-4 rounded-full text-sm sm:text-lg hover:scale-105 transition-transform">
            Get Started Today
          </button>
        </div>
      </div>
