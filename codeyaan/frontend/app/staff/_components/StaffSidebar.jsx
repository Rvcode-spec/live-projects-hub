...
export default function StaffSidebar() {
  ...
  const MenuOption = [
    ...
    { id: 2, name: 'Create Course', path: '/admin/create-course', icon: FilePlus2 }, 
    ...
    { id: 5, name: 'Reports', path: '/admin/reports', icon: BarChart3 },
    { id: 6, name: 'Quizzes', path: '/admin/quizzes', icon: FileQuestion },
    { id: 7, name: 'Notifications', path: '/admin/notifications', icon: Bell },
    { id: 8, name: 'Users', path: '/admin/manage-users', icon: Users },
  ]
